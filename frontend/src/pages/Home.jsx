            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Provident quasi molestiae sunt ipsum atque soluta odio nisi vitae itaque at repudiandae necessitatibus accusantium quis! Fugiat, dolores. Iste, cupiditate odit.
                </p>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className='text__para text-center'>Word-class care for evryone. Our health System offers unmatched, expert healt care</p>
          </div>
          <ServiceList/>
        </div>
      </section>
    ...
    <div className="flex items-center justify-between flex-col lg:flex-row">
      <div className='xl:w-[670px]'>
        ...
        <ul className="pl-4">
          ...
          <li className="text__para"> 3.View Our pysicians who are accepting new patients, use the online scheduling tool to select an appointment time. </li>
      ...
      <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
        ...
        <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
          <div className="flex items-center justify-between">
            ...
            <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rouunded py-1 px-[6px] lg:py-3 lg:px-[9px]'>
              <img src={videoIcon} alt=""/>
            </span>
          </div>
          <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[12px] leading-[8px]lg:text-[12px]lg:;leading-4 text-irisBlurColor font-[500] mt-2 lg:mt-4 rounded-full'>Consultation</div>
...
<section>
  <div className='container'>
    <div className='flex justify-between gap-[50px] lg:gap-0'>
      ...
      <h2 className='heading'>Mos questions by our beloved patients</h2>
